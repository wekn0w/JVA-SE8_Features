...
public class Benchmark2 {
    ...
    public static void main(String... args) {
        ...
        double[] population = DoubleStream.generate(Benchmark2::randInt).limit(POPULATION_SIZE).toArray();

        System.out.println("Imperative version done in: " + measurePerf(Benchmark2::varianceImperative, population) + " msecs");
        System.out.println("Parallel streams version done in : " + measurePerf(Benchmark2::varianceStreams, population) + " msecs");
        System.out.println("ForkJoin version done in : " + measurePerf(Benchmark2::varianceForkJoin, population) + " msecs");
    }
